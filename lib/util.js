...
Util.inherits = function(constructor, superConstructor) {
  ...
  if (superConstructor === NobleDevice) {
    ...
    constructor.startScanning = async function() {
      console.log('In startScanning: >> ', constructor.SCAN_UUIDS);
      await noble.startScanningAsync(constructor.SCAN_UUIDS, constructor.SCAN_DUPLICATES);
    };
